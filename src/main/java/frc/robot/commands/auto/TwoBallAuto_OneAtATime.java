...
public class TwoBallAuto_OneAtATime extends SequentialCommandGroup {

  /**
   * Create a new command.
   */
  public TwoBallAuto_OneAtATime(DriveSubsystem driveSubsystem, CargoSubsystem cargoSubsystem) {
