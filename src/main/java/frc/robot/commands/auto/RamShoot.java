 ...
 */
public class RamShoot extends SequentialCommandGroup {
   ...
   */
  public RamShoot(DriveSubsystem driveSubsystem, CargoSubsystem cargoSubsystem) {
    ...
    new DriveStraight(driveSubsystem, -6*12),
    //delelte these lines if pnumatics are not working
